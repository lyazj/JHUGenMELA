...
public:
  ...
  */
   ...
   *
   * @param[in] MasslessLeptonSwitch Whether you would like your leptons to be massive, by default true.
  */
  ...
  */
   ...
   * 25 | Higgs Boson
   *
   * @attention The particles that you can change when
   * using the JHUGen matrix element are as follow:
   *
   * ipart | Particle Name | Sign Sensitive
   * :---------: | :-----------: | :-----------:
   * 0 OR 21 | Gluon | No
   ...
   * 34 | W Prime | Yes
   *
   * @param[in] inwidth the width that you want in GeV
   * @param[in] ipart the particle whose mass you wish to change
   *
  */
  ...
  */
  ...
  /**
   * @brief computes the production angles for Vector Boson Fusion (VBF) -> H -> ZZ as defined in Figure 1 of [arXiv:1208.4018](https://arxiv.org/abs/1208.4018)
   ...
   * @attention This function requires there to be an input event already defined
   * @warning TO COMPUTE VBF ANGLES CORRECTLY DO NOT INPUT A GEN EVENT (an event with mother particles).
   * This will cause the calculator to make the angles relative to the initial-state particles,
   * making the angle a useless discriminator.
   * @warning This function will edit all values *inplace*. Every value is technically an output.
   * @warning The selection for m1 and m2 are based upon which of the leptons is closer to the z mass. $m_1 \leq m_2$.
   *
   * @param[out] Q2V1 The mass of the first decay particle as reconstructed by 2 of the leptons
   * @param[out] Q2V2 The mass of the first decay particle as reconstructed by 2 of the leptons
   * @param[out] costheta1 $\cos(\theta_1)$
   * @param[out] costheta2 $\cos(\theta_2)$
   * @param[out] Phi $\phi$
   * @param[out] costhetastar $\cos(\theta*)$
  ...
  */
  ...
  /**
   * @brief computes the production for Vector Boson Fusion (VBF) -> H -> ZZ as defined in Figure 1 of [arXiv:1208.4018](https://arxiv.org/abs/1208.4018)
  ...
  */
  ...
  /**
   * @brief computes the angles for a ttH system
   * @sa Calls TUtil::computeTTHAngles to fully calculate angles
   * @attention This function is ill-documented. Use at your own discretion.
   *
   * \param[in] topDecay If topDecay > 0, use unstable tops, otherwise use stable top quarks
