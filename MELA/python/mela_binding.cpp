...
PYBIND11_MODULE(Mela, m) {
    ...
    py::class_<Mela>(m, "Mela")
        ...
        MAKE_COUPLING_REAL_IMAGINARY_SPIN_ZERO(selfDHzzcoupl, ghz1_aux, gHIGGS_VV_1_aux, 0)
        ...
        MAKE_COUPLING_REAL_IMAGINARY_SPIN_ZERO(selfDHzzcoupl, ghz2_aux, gHIGGS_VV_2_aux, 0)
        ...
        MAKE_COUPLING_REAL_IMAGINARY_SPIN_ZERO(selfDHzzcoupl, ghz3_aux, gHIGGS_VV_3_aux, 0)
        ...
        MAKE_COUPLING_REAL_IMAGINARY_SPIN_ZERO(selfDHzzcoupl, ghz4_aux, gHIGGS_VV_4_aux, 0)
